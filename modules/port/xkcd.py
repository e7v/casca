...
def xkcd(casca, input):
    ...
    def tryToGetJSON (site_url):
        try:
            ...
            return casca.say('Failed to access xkcd.com: <' + xkcd_url + '>')
        try:
            body = json.loads(page)
        except:
            return casca.say('Failed to make use of data loaded by xkcd.com: <' + xkcd_url + '>')
        return body
    ...
    if line:
        if line.isdigit():
            ...
            casca.say(u'Incorrect argument for .xkcd: ' + line)
