...
def help(casca, input):
    response = (
        ...
        'of my commands, or see https://github.com/myano/casca/wiki for more ' +
...
def stats(casca, input):
    ...
    for (name, user), count in casca.stats.iteritems():
        if name in ignore:
            continue
        if not user:
            continue
